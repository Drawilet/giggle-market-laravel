<div>
    <x-dialog-modal wire:model="saveUserModal">
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                <label for="store_role" class="block text-sm font-bold mb-2">Role:</label>
                <select id="store_role" wire:model="store_role" required
                    class="block w-full mt-1 p-2 border rounded-md shadow-sm focus:outline-none bg-base-200">
        ...
        <x-slot name="footer">
            <button wire:click="closeSaveUserModal()" type="button" class="btn btn-neutral w-28 mr-2">Cancel</button>
            <button wire:click="saveUser()" type="button" class="btn btn-accent w-28">Save</button>
        </x-slot>
    </x-dialog-modal>
    ...
    <x-dialog-modal wire:model="deleteUserModal">
        ...
        <x-slot name="content">
            ...
            <h2 >¿Are you sure you want do delete "{{ session('name') }}"?</h2>

            <div class=" px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                    <button wire:click.prevent="deleteUser()" type="button"
                        class="inline-flex justify-center w-full rounded-md border border-transparent px-4 py-2 bg-red-500 text-base leading-6 font-medium  shadow-sm hover:bg-red-600 focus:outline-none focus:border-green-700 focus:shadow-outline-green transition ease-in-out duration-150 sm:text-sm sm:leading-5">Delete</button>
                </span>
        ...
        <x-form-section submit="">
            ...
            <x-slot name="description">
                ...
                <button wire:click="openSaveUserModal()"
                    class="block rounded-sm bg-primary  font-bold py-2 px-4 my-3">Add
                    user</button>
